...
public class Driver {
	...
	public static void main(String[] args) throws IOException {
		String path = "/Users/caitlynzheng/eclipse-workspace/commons-math";
		File buildFile;
...
//		path = scanner.nextLine();
		...
		if(str.length == 0) {
			...
			buildFile = new File(path + scanner.nextLine());
			...
			PropertyWriter pw = new PropertyWriter("ant", buildFile, outputFile, path);
			pw.setProperties();

	        AntBuildAnalyzer aba = new AntBuildAnalyzer(buildFile, path);
